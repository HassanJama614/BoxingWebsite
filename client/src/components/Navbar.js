...
// SVG Icons
const ClassesIcon = () => ( /* ... SVG code ... */ <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="nav-icon"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect></svg> );
// Using a "Briefcase" or "Users" icon for "Teach With Us" might be more appropriate
const TeachIcon = () => ( /* Example: Briefcase icon */ <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="nav-icon"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg> );
const LogoutIcon = () => ( /* ... SVG code ... */ <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="nav-icon"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg> );
    ...
    return (
        <nav className="navbar">
            ...
            <ul className="navbar-links">
                ...
                {user ? (
                    <>
                        <li><span className="user-welcome">Welcome, {displayName}</span></li>
                        <li>
                            <button
                        ...
                        <li className="profile-icon-item">
                            <Link to="/profile-settings" className="profile-icon-link" title="Profile Settings">
                                <img
